...
public class adapter extends RecyclerView.Adapter<adapter.holder> {
    ...
    //untuk menyetting nilai yang didapatkan pada viewholder
    @Override
    ...
    //untuk mendapatkan list dari adapter
    ...
    class holder extends RecyclerView.ViewHolder{
        //fungsinya untuk deklarasi variable yang akan digunakan
        public TextView ToDo, Description, Priority;
        public CardView cardv;
        public holder(View itemView){
            super(itemView);
            //berfungsi untuk mengakses id text view pada layout dan juga cardview
